...
export default function ResultsClient() {
  ...
  const getResultBadgeColor = (resultType: string) => {
    switch (resultType.toLowerCase()) {
      case 'excellently prepared':
        return "bg-green-100 text-green-800 border-green-200";
      case 'well prepared':
        return "bg-blue-100 text-blue-800 border-blue-200";
      case 'partially prepared':
        ...
        <Card className="bg-green-50 border-green-200">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 text-green-800">
              ...
              <div>
                <h3 className="font-semibold">Results sent via email!</h3>
                <p className="text-sm text-green-700 mt-1">
                  Your test results have been automatically sent to us. 
                  You will receive more information via email shortly.
                </p>
              </div>
            </div>
          </CardContent>
